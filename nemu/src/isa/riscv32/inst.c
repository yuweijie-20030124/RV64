...
#define INSTPAT_MATCH(s, name, type, ... /* execute body */ ) { \
  ...
  INSTPAT("010000? ????? ????? 101 ????? 00100 11", srai   , I, R(rd) = (sword_t)(int32_t)src1 >> BITS(imm , 5 , 0) ); 
  INSTPAT("0000000 ????? ????? 001 ????? 00110 11", slliw  , I, R(rd) = (sword_t)(int32_t)((uint32_t)src1 << BITS(imm, 4, 0)););
  INSTPAT("0000000 ????? ????? 101 ????? 00110 11", srliw  , I, R(rd) = (sword_t)(int32_t)((uint32_t)src1 >> BITS(imm, 4, 0)););
  INSTPAT("0100000 ????? ????? 101 ????? 00110 11", sraiw  , I, R(rd) = (sword_t)(int32_t)((int32_t)src1 >> BITS(imm, 4, 0)););
  INSTPAT("??????? ????? ????? 100 ????? 00000 11", lbu    , I, R(rd) = Mr(src1 + imm, 1));
  INSTPAT("??????? ????? ????? 000 ????? 00100 11", addi   , I, R(rd) = src1 + imm);
  INSTPAT("??????? ????? ????? 000 ????? 00110 11", addiw  , I, R(rd) = (sword_t)(int32_t)(src1 + imm));
  ...
  INSTPAT("0000000 ????? ????? 000 ????? 01110 11", addw   , R, R(rd) = (sword_t)(int32_t)((uint32_t)src1 + (uint32_t)src2));
  INSTPAT("0100000 ????? ????? 000 ????? 01110 11", subw   , R, R(rd) = (sword_t)(int32_t)((uint32_t)src1 - (uint32_t)src2));
  INSTPAT("0000000 ????? ????? 001 ????? 01110 11", sllw   , R, R(rd) = (sword_t)(int32_t)((uint32_t)src1 << (src2 & 31)););
  INSTPAT("0000000 ????? ????? 101 ????? 01110 11", srlw   , R, R(rd) = (sword_t)(int32_t)((uint32_t)src1 >> (src2 & 31)););
  INSTPAT("0100000 ????? ????? 101 ????? 01110 11", sraw   , R, R(rd) = (sword_t)(int32_t)((int32_t)src1 >> (src2 & 31)););

  INSTPAT("0100000 ????? ????? 000 ????? 01100 11", sub    , R, R(rd) = src1 - src2); 
  INSTPAT("0000001 ????? ????? 000 ????? 01100 11", mul    , R, R(rd) = (word_t)((__int128)(sword_t)src1 * (sword_t)src2));
  INSTPAT("0000001 ????? ????? 001 ????? 01100 11", mulh   , R, R(rd) = (word_t)(((__int128)(sword_t)src1 * (sword_t)src2) >> 64));
  INSTPAT("0000001 ????? ????? 010 ????? 01100 11", mulhsu , R, R(rd) = (word_t)(((__int128)(sword_t)src1 * (unsigned __int128)(word_t)src2) >> 64));
  INSTPAT("0000001 ????? ????? 011 ????? 01100 11", mulhu  , R, R(rd) = (word_t)(((unsigned __int128)(word_t)src1 * (unsigned __int128)(word_t)src2) >> 64));
  INSTPAT("0000001 ????? ????? 100 ????? 01100 11", div    , R, if (src2 == 0) R(rd) = (word_t)-1;else if ((sword_t)src1 == INT64_MIN && (sword_t)src2 == -1) R(rd) = INT64_MIN;else R(rd) = (sword_t)src1 / (sword_t)src2;);
  INSTPAT("0000001 ????? ????? 101 ????? 01100 11", divu   , R, if (src2 == 0) R(rd) = (word_t)-1;else R(rd) = (word_t)src1 / (word_t)src2;);
  INSTPAT("0000001 ????? ????? 110 ????? 01100 11", rem    , R, if (src2 == 0) R(rd) = src1;else if ((sword_t)src1 == INT64_MIN && (sword_t)src2 == -1) R(rd) = 0;else R(rd) = (sword_t)src1 % (sword_t)src2;);
  INSTPAT("0000001 ????? ????? 111 ????? 01100 11", remu   , R, if (src2 == 0) R(rd) = src1;else R(rd) = (word_t)src1 % (word_t)src2;);
  INSTPAT("0000001 ????? ????? 000 ????? 01110 11", mulw   , R, R(rd) = (sword_t)(int32_t)((int32_t)src1 * (int32_t)src2));
  INSTPAT("0000001 ????? ????? 100 ????? 01110 11", divw   , R, if (src2 == 0) R(rd) = (sword_t)-1; else if ((int32_t)src1 == INT32_MIN && (int32_t)src2 == -1) R(rd) = (sword_t)INT32_MIN; else R(rd) = (sword_t)(int32_t)((int32_t)src1 / (int32_t)src2););
  INSTPAT("0000001 ????? ????? 101 ????? 01110 11", divuw  , R, if (src2 == 0) R(rd) = (sword_t)-1; else R(rd) = (sword_t)(int32_t)((uint32_t)src1 / (uint32_t)src2););
  INSTPAT("0000001 ????? ????? 110 ????? 01110 11", remw   , R, if (src2 == 0) R(rd) = (sword_t)(int32_t)src1; else if ((int32_t)src1 == INT32_MIN && (int32_t)src2 == -1) R(rd) = 0; else R(rd) = (sword_t)(int32_t)((int32_t)src1 % (int32_t)src2););
  INSTPAT("0000001 ????? ????? 111 ????? 01110 11", remuw  , R, if (src2 == 0) R(rd) = (sword_t)(int32_t)src1; else R(rd) = (sword_t)(int32_t)((uint32_t)src1 % (uint32_t)src2););
